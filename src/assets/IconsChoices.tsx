export function IconRock({ onClick }: { onClick: () => void }) {
  return (
    <button
      className="p-4 overflow-hidden rounded-full bg-gradient-to-t from-primary-rock-from to-primary-rock-to max-size-[160px]"
      onClick={onClick}
    >
      <div className="relative px-10 pt-8 pb-10 overflow-hidden bg-white border-t-8 rounded-full border-t-neutral-headeroutline/45">
...
export function IconPaper({ onClick }: { onClick: () => void }) {
  return (
    <button
      className="p-4 overflow-hidden rounded-full bg-gradient-to-t from-primary-paper-from to-primary-paper-to max-size-[160px]"
      onClick={onClick}
    >
      <div className="relative px-10 pt-6 pb-10 overflow-hidden bg-white border-t-8 rounded-full border-t-neutral-headeroutline/45">
...
export function IconScissors({ onClick }: { onClick: () => void }) {
  return (
    <button
      className="p-4 overflow-hidden rounded-full bg-gradient-to-t from-primary-scissor-from to-primary-scissor-to"
      onClick={onClick}
    >
